...
/**
 * Specialization of the SelectSockets class which uses a thread pool to
 * service channels. The thread pool is an ad-hoc implementation quicky lashed
 * togther in a few hours for demonstration purposes. It's definitely not
 * production quality.
 * 
...
public class SelectSocketsThreadPool extends SelectSockets {
	...
	protected void readDataFromSocket(SelectionKey key) throws Exception {
		...
		System.out.println("************************");
		System.out.println("server thread pool start");
	 ...
	 * time and remains fixed. Threads are cycled through a FIFO idle queue. 155
	 */
	 ...
	 * worker 156 thread returns itself to its parent pool.
	 */
	private class WorkerThread extends Thread {
		...
		void drainChannel(SelectionKey key) throws Exception {
			...
			int count;
			System.out.println("server thread pool drains");
