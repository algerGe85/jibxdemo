...
/**
 * 191 A file searching class, similar to grep, which returns information about
 * lines matched in the specified files. Instances of this class * are tied to a
 * specific regular expression pattern and may be applied * repeatedly to
 * multiple files. Instances of Grep are thread safe, they may be shared.
 * 
...
public class Grep {
	 ...
	 *            when this Grep instance was constructed. 192
	 ...
	 * <li>start(): The index within the line where the matching pattern begins.
	 * </li>
	...
	public static class MatchedLine {
		...
		MatchedLine(File file, int lineNumber, String lineText, int start,
				int end) {
			this.file = file;
